...
This directory holds AegisForge's architecture decisions. After the
...
| [0005](0005-uv-workspace-monorepo.md) | uv workspace monorepo with `aegisforge.*` namespace | Accepted |
