...
## Context
CortexWard must support Anthropic, OpenAI, Gemini, Ollama, vLLM, and LiteLLM-compatible providers,
...
accounting, cost) in `cortexward-llm`. Ship native **Anthropic** and **OpenAI** adapters, a
