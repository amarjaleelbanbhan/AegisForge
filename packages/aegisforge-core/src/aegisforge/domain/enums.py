"""Core domain enumerations for AegisForge.
...
class VerificationRung(IntEnum):
    """Rungs of the AegisForge Verification Ladder.

    The central thesis of AegisForge is that a finding is only as trustworthy as
...
class FindingState(StrEnum):
    ...
    human or patch actions; see :mod:`aegisforge.domain.verification`.
    """
...
class VexStatus(StrEnum):
    ...
    first-class AegisForge output: it answers "is this actually exploitable in
