...
This module is the formal core of AegisForge's central thesis. Given the
:class:`~aegisforge.domain.models.Evidence` attached to a finding, it computes:
...
Two safety policies are baked in, reflecting AegisForge's trust model:
...
from aegisforge.domain.models import Evidence, Finding
